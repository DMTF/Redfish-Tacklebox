...
def get_messages_detail( response ):
    ...
    try:
        error_body = response.dict["error"]
        if "code" in error_body:
            messages_detail["code"] = error_body["code"]
        if "message" in error_body:
            messages_detail["message"] = error_body["message"]
        if "@Message.ExtendedInfo" in error_body:
            messages_detail["@Message.ExtendedInfo"] = error_body["@Message.ExtendedInfo"]
    except:
        messages_detail["code"] = ""
        messages_detail["message"] = ""
        messages_detail["@Message.ExtendedInfo"] = []
